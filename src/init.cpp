...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-hf1time", strprintf("Emergency hardfork (default: %u)", 1614992554), ArgsManager::ALLOW_ANY, OptionsCategory::RPC); // TODO: Remove
...
bool AppInitParameterInteraction()
{
    ...
    // Remove
    EXPLOIT_FIX_HF1_TIME = gArgs.GetArg("-hf1time", gArgs.GetChainName() == CBaseChainParams::REGTEST ? 0 : 1614992554);
