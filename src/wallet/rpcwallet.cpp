    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getnewaddress",
                ...
                RPCResult{
            "\"address\"    (string) The new ghost address\n"
                },
                RPCExamples{
...
static UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The ghost address\n"
        ...
        return NullUniValue;
            ...
            RPCHelpMan{"addmultisigaddress",
                ...
                "If 'label' is specified, assign address to that label.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of ghost addresses or hex-encoded public keys",
                        {
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "[\n"
            "  {\n"
            "    \"address\":\"address\",    (string) The ghost address of the transaction.\n"
...
UniValue gettransaction(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "  \"details\" : [\n"
            "    {\n"
            "      \"address\" : \"address\",          (string) The ghost address involved in the transaction\n"
            "      \"category\" :                      (string) The transaction category.\n"
            "                   \"send\"                  Transactions sent.\n"
            "                   \"receive\"               Non-coinbase transactions received.\n"
            "                   \"generate\"              Coinbase transactions received with more than 100 confirmations.\n"
...
static UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "A json array of ghost addresses to filter",
                        {
            ...
            "    \"coldstaking_address\"  : \"address\" (string) the ghost address this output must stake on\n"
...
UniValue getaddressinfo(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "\nReturn information about the given ghost address. Some information requires the address\n"
            "to be in the wallet.\n",
                {
                ...
                RPCResult{
            "{\n"
            "  \"address\" : \"address\",        (string) The ghost address validated\n"
