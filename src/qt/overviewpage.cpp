...
void OverviewPage::setBalance(const interfaces::WalletBalances& balances)
{
    ...
    if (walletModel->wallet().isLegacy()) {
        if (walletModel->wallet().privateKeysDisabled()) {
            ...
            ui->labelImmature->setText(BitcoinUnits::formatWithPrivacy(unit, balances.immature_balance + balances.immature_anon_balance, BitcoinUnits::separatorAlways, m_privacy));
            ui->labelTotal->setText(BitcoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance
                + balances.balanceStaked + balances.balanceBlind + balances.balanceAnon, BitcoinUnits::separatorAlways, m_privacy));
            ...
            ui->labelWatchTotal->setText(BitcoinUnits::formatWithPrivacy(unit, balances.watch_only_balance + balances.unconfirmed_watch_only_balance + balances.immature_watch_only_balance
                + balances.balanceWatchStaked, BitcoinUnits::separatorAlways, m_privacy));

            ui->labelStaked->setText(BitcoinUnits::formatWithPrivacy(unit, balances.balanceStaked, BitcoinUnits::separatorAlways, m_privacy));
            ui->labelBlindBalance->setText(BitcoinUnits::formatWithPrivacy(unit, balances.balanceBlind, BitcoinUnits::separatorAlways, m_privacy));
            ui->labelAnonBalance->setText(BitcoinUnits::formatWithPrivacy(unit, balances.balanceAnon, BitcoinUnits::separatorAlways, m_privacy));
            ui->labelWatchStaked->setText(BitcoinUnits::formatWithPrivacy(unit, balances.balanceWatchStaked, BitcoinUnits::separatorAlways, m_privacy));
        }
    } else {
        ui->labelBalance->setText(BitcoinUnits::formatWithPrivacy(unit, balances.balance, BitcoinUnits::separatorAlways, m_privacy));
        ui->labelUnconfirmed->setText(BitcoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, BitcoinUnits::separatorAlways, m_privacy));
