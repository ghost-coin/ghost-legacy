...
BOOST_AUTO_TEST_CASE(blockfilter_basic_test)
{
    ...
    BlockFilter block_filter(BlockFilterType::BASICFILTER, block, block_undo);
...
BOOST_AUTO_TEST_CASE(blockfilters_json_test)
{
    ...
    for (unsigned int i = 0; i < tests.size(); i++) {
        ...
        BlockFilter computed_filter_basic(BlockFilterType::BASICFILTER, block, block_undo);
...
{
    BOOST_CHECK_EQUAL(BlockFilterTypeName(BlockFilterType::BASICFILTER), "basic");
    ...
    BOOST_CHECK_EQUAL(filter_type, BlockFilterType::BASICFILTER);
