...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        for unit, fee_rate in {"part/kb": 0.1, "sat/b": 10000}.items():
        ...
        for mode in ["unset", "economical", "conservative", "part/kb", "sat/b"]:
            ...
            if mode in ["part/kb", "sat/b"]:
                assert_raises_rpc_error(-3, "Amount out of range",
                    lambda: self.nodes[1].walletcreatefundedpsbt(inputs, outputs, 0, {"estimate_mode": mode, "conf_target": -1, "add_inputs": True}))
                assert_raises_rpc_error(-4, "Fee rate (0.00000000 PART/kB) is lower than the minimum fee rate setting (0.00001000 PART/kB)",
        ...
        for unit, fee_rate in {"SAT/B": 0.99999999, "PART/KB": 0.00000999}.items():
            ...
            assert_raises_rpc_error(-4, "Fee rate (0.00000999 PART/kB) is lower than the minimum fee rate setting (0.00001000 PART/kB)",
